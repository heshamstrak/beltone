        ...
        <div class="col-12">
            <div class="card">
                <div style="padding: 20px">
                    ...
                    <a href="{{ route('admin.'.$name.'.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create</a>
...
@push('js')
    ...
    <script>
        ...
        let adminsTable = $('#blogs-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            ajax: {
            ...
            columns: [
                ...
                {data: 'video_gallery', name: 'video_gallery', searchable: false, sortable: false},
