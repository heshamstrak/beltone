                ...
                <div class="col-md-12">
                    ...
                    <div class="tile shadow">
                        ...
                        <form method="post" action="{{ route('admin.'.$name.'.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Job</label>
                                <input type="text" name="job" autofocus class="form-control" value="{{ old('job') }}" required>
                            </div>

                            {{--Phone--}}
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="number" name="phone" autofocus class="form-control" value="{{ old('phone') }}">
                            </div>

                            {{--Facebook Link--}}
                            <div class="form-group">
                                <label>Facebook Link</label>
                                <input type="url" name="facebook_link" autofocus class="form-control" value="{{ old('facebook_link') }}" placeholder="Facebook Link">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="twitter_link" autofocus class="form-control" value="{{ old('twitter_link') }}" placeholder="Twitter Link">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="linkedin_link" autofocus class="form-control" value="{{ old('linkedin_link') }}" placeholder="Linkedin Link">
                            </div>
